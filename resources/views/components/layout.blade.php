...
<head>
    ...
    <!-- Android -->
    <link rel="shortcut icon" sizes="192x192" href="images/favicon/android-chrome-192x192.png">
    <link rel="shortcut icon" sizes="512x512" href="images/favicon/android-chrome-512x512.png">
    ...
    <title>HotJob | Find Hot Jobs & Projects</title>
</head>
<body class="mb-48">
